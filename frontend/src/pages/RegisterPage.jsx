    ...
    <div className="flex justify-center items-center mt-10 md:mt-20">
      <div className="w-full max-w-md p-8 space-y-6 bg-[#1E1E1E] rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-2">Join the community of writers and readers.</p>
        </div>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="mt-1 block w-full px-3 py-2 bg-transparent border-b-2 border-gray-600 focus:outline-none focus:border-[#00A8E8] transition-colors" required />
          </div>
          <div>
        ...
        <div className="text-center text-gray-400">
          <p>Already have an account? <Link to="/login" className="text-[#00A8E8] hover:underline">Log In</Link></p>
        </div>
      </div>
    </div>
  );
